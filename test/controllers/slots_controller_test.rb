...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { available: @slot.available, end_time: @slot.end_time, schedule_id: @slot.schedule_id, start_time: @slot.start_time } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { available: @slot.available, end_time: @slot.end_time, schedule_id: @slot.schedule_id, start_time: @slot.start_time } }
